...
= start
  ...
  * [Next]
  ...
  "What? Where is this coming from?" Rex asked. "We have been winning! Look at all the money we've earned, all the upgrades we have. We win the championship here, and we can get into the galaxy qualifying rounds."
  ...
  * [Start Battle]
  ...
  IronWolf tried to calculate the best evasive maneuvers while Rex guided the general direction. They where moving forward, which was easy considering the arena lacked any obstacles Rex and IronWolf could use.
  A brief wave of heat soared past IronWolf as he zagged. The plasma ball from the Altas' particle projector, missed by meters.
  ...
  * [IronWolf Status]
  ...
  // IronWolf fired his Guass Rifle, using {power_cost(GuassRifle)} POWER and generating {heat_cost(GuassRifle, 1)} waste HEAT.
  ...
  // Atlas fired 5 lasers, using {power_cost(Laser)} POWER and generating {heat_cost(Laser, 5)} waste HEAT.
