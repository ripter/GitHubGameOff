Game Off 2018 is a month long jam to write a game the follows a theme. The theme this year is Hybrid.
...
* Play The Hybrid Novel Game (Unfinished)
  -> play_full_game
* Read Novel NaNoWriMo (First Draft)
  -> nanowrimo_only
* Play the Game (First Demo)
  -> battle_only
